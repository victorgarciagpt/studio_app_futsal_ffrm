            ...
            <Accordion type="single" collapsible className="w-full space-y-4">
                ...
                <AccordionItem value="item-3" className="border rounded-lg">
                    <AccordionTrigger className="text-lg font-semibold text-primary p-4 hover:no-underline">3. Normativa Específica de los Encuentros</AccordionTrigger>
                     <AccordionContent className="p-6 pt-0 space-y-4 text-muted-foreground">
                        <Point title="15">
                           <strong>Brazalete:</strong> Se recuerda a todo el Colectivo Arbitral que todo equipo tiene un capitán que deberá llevar el distintivo, en caso de no llevar el brazalete, esta función la ejercerá el portero designado por el equipo.
                        ...
                        <Point title="31">
                            <strong>Regla Pasarela:</strong> Aplicable en las categorías División de Honor y Liga Autonómica Alevín, 2ª Alevín, División de Honor y Liga Autonómica Benjamín, 2ª Benjamín, Prebenjamín, Prebenjamín Murcia y, Femenino Alevín Fútbol Sala. Cada jugador debe jugar un mínimo de 1 periodo y descansar mínimo 1 periodo entre los 3 primeros. No se podrán realizar sustituciones en los 3 primeros periodos salvo lesión. En el 4º periodo, los cambios son libres. Es obligatorio reflejar las alineaciones de cada periodo en el acta.
                        </Point>
                        <Point title="32">
                        ...
                        <Point title="33">
                           <strong>Sustitución de jugadores:</strong> La sustitución será efectiva en el momento en el que el jugador abandone la superficie de juego por su zona de sustituciones y el sustituto ingrese en la pista posteriormente. El jugador suplente deberá entregar el peto al jugador sustituido.
                        </Point>
                        <Point title="18">
                           <strong>Diferencia de 10 Goles:</strong> En las categorías masculinas Infantil, Alevín, Benjamín, Prebenjamín, Prebenjamín Murcia Fútbol Sala, 2ª Categorías y en todas las femeninas Preferente, Juvenil, Cadete, Infantil y 2ª Categorías, cuando se produce una diferencia de 10 goles durante el transcurso del encuentro, no se anotarán más goles.
                        </Point>
                        <Point title="19">
                           <strong>Saque de Meta / Cesión:</strong> En TODAS las categorías, si en un saque de meta el portero traspasa la línea de medio campo, se le sancionará con un tiro libre indirecto a favor el equipo contrario. Se reanuda con el balón sobre la línea del centro del campo donde pasó el balón. En las categorías Prebenjamín, Prebenjamín Murcia Fútbol Sala y Debutantes, cuando sancionamos una infracción por cesión al portero, se ejecutará con un saque de banda, a favor del equipo contrario en el lugar más cercano a donde se cometió la infracción.
                        </Point>
                        <Point title="20">
